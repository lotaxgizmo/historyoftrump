...
function Disclaimer() {
    return (
        <div className='flex flex-col justify-center items-center p-3'>
            ...
            <p className='text-[#03124D] text-3xl lg:text-4xl brin text-center lg:w-10/12 w-auto'>$HOT ( History of Trump ) The Messiah Meme is here . The crypto world has always been at war with forces  against its very existence, it has always faced trials since its inception. But all that's about to change , the crypto world has found a new ally in  Donald Trump. Just like the crypto world, Trump has faced a lot of trials, survived assassination attempts and has conquered  it all. With Trump and cryptonians combining forces,
                <br />
                <br />
                a new world is  achievable .
